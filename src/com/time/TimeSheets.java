...
public class TimeSheets {
    public static void main(String args[]) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"menu_time_Timesheets\"]")).click();  
        driver.findElement(By.xpath("//*[@id=\"menu_time_viewEmployeeTimesheet\"]")).click(); 
        driver.findElement(By.xpath("//*[@id=\"employee\"]")).clear();
        driver.findElement(By.xpath("//*[@id=\"employee\"]")).sendKeys("Test User");
