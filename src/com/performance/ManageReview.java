...
public class ManageReview {
    public static void main(String args[]) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"menu_performance_ManageReviews\"]")).click();  
        driver.findElement(By.xpath("//*[@id=\"menu_performance_searchPerformancReview\"]")).click(); 

        Thread.sleep(2000);
        driver.findElement(By.xpath("//*[@id=\"performanceReview360SearchForm_employeeName\"]")).sendKeys("John Smith");
        Thread.sleep(2000);
