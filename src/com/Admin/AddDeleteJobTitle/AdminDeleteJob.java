 ...
 */
package com.Admin.AddDeleteJobTitle;
...
public class AdminDeleteJob {
     public static void main(String args[]) throws InterruptedException {
        ...
        WebElement check = driver.findElement(By.id("ohrmList_chkSelectRecord_10"));

        if (check.isSelected()) {
            System.out.println("Job Title Checkbox is Toggled On");

        } else {
            System.out.println("Job Title Checkbox is Toggled Off");
        }        
        check.click();        
        driver.findElement(By.xpath("//*[@id=\"btnDelete\"]")).click();
        driver.findElement(By.xpath("//*[@id=\"dialogDeleteBtn\"]")).click();        
        System.out.println ("ICT has been Deleted");
    }
